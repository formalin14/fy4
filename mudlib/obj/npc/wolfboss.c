...
void setboss(object who, int level)
{
        ...
        set("str",30+random(level/4)+level/5);
        set("kee",20000+level*40);
        set("max_kee",20000+level*40);
        set("eff_kee",20000+level*40);
        set("sen",20000+level*40);
        set("max_sen",20000+level*40);
        set("eff_sen",20000+level*40);
        set("gin",20000+level*40);
        set("max_gin",20000+level*40);
        set("eff_gin",20000+level*40);
