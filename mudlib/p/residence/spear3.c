...
set("short", "潭畔");
set("long", @LONG
走过了红树林的前端，来到了树林中间，这里光线比树林里亮很多，
阳光泛在小潭上，映照出来点点绿波。目光绕过小潭，可以看见对面有三
两间木屋，木屋的篱笆前堆着一堆刚砍下来的木柴，一个小火炉。

LONG
);
        set("exits", ([
"south" : __DIR__"spear2",
"east" : __DIR__"spear4",
]));
set("objects", ([
                "/p/residence/npc/singlewa" : 1,
       ]) );
        set("coor/x",X_COOR);
        set("coor/y",Y_COOR);
        set("coor/z",Z_COOR);
