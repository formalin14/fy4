...
set("short", "白霞居");
set("long", @LONG
    房间里一应具全：中间是一张意大利大地毯，左面有一个壁炉，里面燃着火光，给人以温馨感。
边上有一张三十人的大餐桌，上面放着法国银餐具，一看就知道主人的好客。对面的墙雪白一片
是看投影的绝佳选择。楼梯上可看到半掩着门的房间正中一张白白的肥蛆和紫霞的婚照，在蓝光
的渲染下异常的夺目。 
LONG
);
        set("exits", ([
"west" : "/p/residence/recall1014842649.c",
]));
set("objects", ([
       ]) );
        set("coor/x",X_COOR);
