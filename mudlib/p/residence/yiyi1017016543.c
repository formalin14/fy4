...
LONG
        ...
        set("exits", ([
"north" : __DIR__"galahad1025760765",
"east" : __DIR__"wofong1018805113",
"down" : __DIR__"yiyi1018678300",
"up" : __DIR__"yiyi1017457367",
"west" : "/p/residence/room4.c",
])); 
        set("resource/water", 1);
    set("liquid/container", "蒙蒙细雨");
    set("liquid/name", "蒙蒙细雨");     
set("objects", ([
       ]) );
        set("coor/x",X_COOR);
        set("coor/y",Y_COOR);
