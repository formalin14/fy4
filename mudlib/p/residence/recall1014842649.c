...
set("short", "九霄峰山脚");
set("long", @LONG
九霄峰乃当今最高最险峻的山峰，高耸入云，乃回忆穷十
年之功，以移山换海之术所变成的。当地人称之为九霄峰。
你只见山峰中段以上皆被云海所掩没，所能看见的只是光秃
秃的山脚，一夥树也没有。只有一条极之陡峭的青石阶由山
脚直上山顶，像一条青龙般直冲云霄。 
LONG
);
        set("exits", ([
"down" : __DIR__"still1037424235",
"north" : __DIR__"desy1036241956",
"east" : __DIR__"zxia1033309659",
"west" : __DIR__"baby1032108114",
"up" : __DIR__"recall1014843694",
"south" : "/p/residence/room4.c",
]));
set("objects", ([
       ]) );
        set("coor/x",X_COOR);
