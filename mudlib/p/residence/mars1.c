...
void create()
{
set("short", WHT"峨嵋十八居"NOR);
set("long", @LONG
拾阶而上，举目远望，前方建有山居一座，这里青山绿水，常年
烟雾缭绕，看上去颇有仙气，山居有一扇清雅木门禁闭，门前两旁松
树林立，其间间杂着无数奇花异草，想来此间主人仙风道骨，宁人敬
仰。
LONG
);
        set("exits", ([
...
int do_push(string arg)
{
        ...
        me = this_player();
        if( arg=="door" || arg =="木门") {
        message_vision("$N往木门上轻轻地一推，吱......的一声木门开了。\n", me);
                set("exits/north", __DIR__"mars2");
