...
set("short", "古厅");
set("long", @long
一间古厅，一张大榻，一只短几，一壶酒，一缸水，两个用青丝
竹编成的枕头，以及叁面墙。其他一切，这里什麽都没有，桌椅摆设
家具字画杯盏，别的屋子里应该都有的，这里全都没有。
long

);
        set("exits", ([
"south" : __DIR__"yxiao4",
]));   
set("objects", ([
       ]) );
        set("coor/x",X_COOR);
...
int do_sleep(string arg)
{
   ...
   if (this_object()->query_temp("marks/taken")) {
      tell_object(me, "榻上有人耶。。。。\n");
      return 1;
   }
      else{
      message_vision("$N揉揉眼、打个哈欠，躺到了榻上，", me);
