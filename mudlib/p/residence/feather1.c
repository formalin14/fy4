...
void create()
{
set("short", HIG"柳浪闻莺"NOR);
set("long", @long
路旁杨柳交错成林，晴中见潋滟，雨中显空蒙。路的尽头莺飞草长，
桃红柳绿，青山含翠，远处接天莲碧的荷花，以及隐约可见疏影横斜的红
梅，更有那烟柳笼纱中的莺啼，都令人流连忘返。
long
);
        set("exits", ([
"east" : __DIR__"room4",
"south" : __DIR__"feather1",
"west" : __DIR__"feather1",
"north" : __DIR__"feather1",
"southeast" : __DIR__"feather1",
"southwest" : __DIR__"feather1",
"northeast" : __DIR__"feather2",
"northwest" : __DIR__"feather4",
]));
set("objects", ([
       ]) );
        set("coor/x",X_COOR);
