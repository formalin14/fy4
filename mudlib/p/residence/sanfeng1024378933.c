...
set("short", "紫霄福地");
set("long", @LONG
殿宇依山而筑，高低错落有致。周围古木参天，翠竹成林，鸟语花香，景
色清幽，好一个修道成仙处。殿顶由四根八丈高的红柱撑著，地板则是由白玉
石铺成。这里供着道德天尊、元始天尊和灵宝天尊的神像。正面墙上挂著武当
开山祖师——张三丰的画像，正上方高高地挂起一块金匾，上书“紫霄福地”
四字。匾下是个敬香的大香案，上面放著一只铜炉，几只缓缓冒著青烟的供香
插在其中。靠墙放着几张太师椅，地上放着几个蒲团。 
LONG
);
        set("exits", ([
