...
set("short", "听雨阁");
set("long", @LONG
这是一间很普通的小屋，几张凳子，一张小桌，一边的梳妆台上斜斜的放着几个小玩具。
很简单的摆设，却让你感到说不出的舒适。
一个年轻的女子，正斜依着窗栏，默默的看着窗外那蒙蒙细雨。。
她也许不是很漂亮，但是却让人不由自主的有一种亲切感，想去亲近她。。 
LONG
);
        set("exits", ([
"up" : __DIR__"sunlx1020784314",
"eastdown" : "/p/residence/room4.c",
]));
set("objects", ([
       ]) );
        set("coor/x",X_COOR);
