...
set("short", "正厅");
set("long", @LONG
室内室外死静一片，楼外後院有一扇门似乎被风吹开了，在深夜里咿
哑作响，却一直没有人去把门关好。明厅後一曲朱栏竹梯，回旋而上，梯
上小小一方匾额，正是主人自题，写的是「弹剑楼」。明厅当中则也是主
人自题的一副对联。

LONG
);
        set("exits", ([
"out" : __DIR__"shenlany1",
"up" : __DIR__"shenlany3",
"north" : __DIR__"shenlany4",
]));
set("objects", ([
       ]) );
       set("item_desc", ([
