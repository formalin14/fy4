...
set("short", "自然居");
set("long", 
"小屋中陈设亦是清雅有致，不同凡俗。左面的墙上挂着
一把魔刀当年号令天下时用的" + HIR"斩仙刀"NOR + "，右面的墙上挂着一把
樱桃当年纵横江湖时用的" + HIM"细雨剑"NOR + "。
正中挂着一幅字：
...
"
        ...
        set("exits", ([
"east" : __DIR__"cherry5",
"north" : __DIR__"cherry3",
]));    
set("objects", ([
       ]) );
set("item_desc", ([
                "斩仙刀": HIR"刀身微微透着红芒。你拔开刀，一股凄厉的杀气扑面而来。\n"NOR,
                "细雨剑" : HIM"窄而细长的宝剑，你注视着它，有种很温柔的感觉，不禁想把自己的头凑上去。。。\n"NOR
        ]) );
