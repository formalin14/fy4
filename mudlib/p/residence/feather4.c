...
void create()
{
set("short", HIM"曲院风荷"NOR);
set("long", @long
广阔而秀丽的湖，湖边的护栏式样多变。越来越小的耐心，使我
们再也造不出那麽精细的护栏，而柳树的枝条还是轻松地悬挂着，那
都是不屈的泥土的功劳。
long

);
        set("exits", ([
"south" : __DIR__"feather4",
"east" : __DIR__"feather4",
"west" : __DIR__"feather4",
"north" : __DIR__"feather4",
"southeast" : __DIR__"feather1",
"southwest" : __DIR__"feather4",
"northeast" : __DIR__"feather4",
