...
set("short", "祁丽丽居");
set("long", @LONG
丽丽是阿宝一生的至爱，只可惜阿宝命运不济，识丽丽恨晚。阿宝愿一生一世热爱丽丽而
决不易情别恋，虽然阿宝注定一无所获。
丽丽，你来世嫁给我，好吗？
在跌落的湿草地里扑打泥泞。怎么也摆不脱这丁香暗结的愁怨，怎么洞穿
花雨伞下恋侣的芳心是否火热。打碎爱的杯盏，维纳斯离我而去，
只留下诗意的孤单失意的影，在苍茫的天之一隅流泪。祈祷
时光挽住短暂的美丽，却终归是泡影，不能挽留岁月落花流水，
也不能挽留爱情。在缘尽的时分，我只要一滴眼泪，珍藏
童年和梦。走出湿意浓浓的天空，走出伤感。 
LONG
);
        set("exits", ([
"south" : "/p/residence/desy1036241956.c",
]));
set("objects", ([
       ]) );
        set("coor/x",X_COOR);
