...
set("short", "草地");
set("long", @LONG
走过翠嶂，只觉眼前豁然开朗。面前一片碧绿的草地，远处一片秀峰相连，
风光迷人。不见人烟，远离滚滚红尘。山上除了常见的松树、杉树，还有毛竹、
榉树，香樟、槭树。多种色彩辉映，斑斓缤纷，清朗明丽，宛若童话仙境。蓝
天，白云，森林，草地，一切都繁茂而明朗，纯净而妩媚。
LONG
);
        set("exits", ([
"south" : __DIR__"cherry3",
"north" : __DIR__"cherry1",
])); 
set("objects", ([
       ]) );
        set("coor/x",X_COOR);
