...
set("short", "元帅堂");
set("long", @LONG
大堂居中，两旁分列十个亭子，称为十将亭。大堂是一座八角重檐亭
子建成，正门有两根盘龙柱，以示庄严。两旁墙上悬皇帝御书「清慎勤」
匾额，又挂有「保百重任」匾额及「正己风群吏，精心理庶民」对联。先
帝御笔「泽润丞黎」匾额及其上谕《恤刑》一道，则悬於堂中。
...
"north" : __DIR__"zack4",
"south" : __DIR__"zack2",
"west" : __DIR__"berjaya1",
"east" : __DIR__"berjaya2",
