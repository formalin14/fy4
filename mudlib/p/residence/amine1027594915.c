...
set("short", "纯天然温泉桑拿浴室");
set("long", @LONG
这里是整个建筑群的唯一浴室，没有哈密秧子的特批，是不能进来的。
这里有个不成文的规定，不是一对夫妇或情侣，是不可以来的，里面有三个包间，最多能有三对同时冲凉。
通过这里的闭路电视，可以看到，现在正有一对情侣，互相在帮助对方穿着衣服，想必是他们已经完成了。
还有一对正在嬉笑着。。。。。。。。 
LONG
);
        set("exits", ([
"south" : "/p/residence/wofong1027399371.c",
]));
set("objects", ([
       ]) );
        set("coor/x",X_COOR);
