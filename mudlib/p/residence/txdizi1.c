...
set("short", "铁血小庐");
set("long", @long
路边一间青青的毛砖搭成小小的石屋。建筑不施彩画，
青砖灰瓦，木柱古朴，座基低平，台阶由山石叠砌，屋中几
乎所有的家具都是用青竹编成的。屋中的竹几上放着一套名
贵的紫砂茶具。

long
);
        set("exits", ([
"east" : __DIR__"txdizi3",
"south" : __DIR__"room5",
"west" : __DIR__"txdizi2",
"north" : __DIR__"txdizi4",

]));
set("objects", ([
"/p/residence/npc/txdiziwa" : 1,
       ]) );
        set("coor/x",X_COOR);
        set("coor/y",Y_COOR);
        set("coor/z",Z_COOR);
