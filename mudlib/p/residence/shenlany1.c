...
#define Z_COOR 50
#define R_FLAG 2561
#define OWNER "shenlany"
#define CLASS "财神庙"
inherit ROOM;
void create()
{
set("short", HIG"天下第一楼"NOR);
set("long", @LONG
绕过广场之西，是一座小小竹楼，远远望见楼头一区横额，写的却
是「弹剑楼」，笔力刚健，龙飞凤舞。眼前庭院深沉的屋宇，黑漆的大
门上，滴水的飞檐下，斜插着一面黑缎绸底，当中绣着一个血红的「剑」
字的旗帜，咧咧迎风招展。
LONG
);
        set("exits", ([
"eastdown" : __DIR__"room3",
"enter" : __DIR__"shenlany2",
]));
set("objects", ([
       ]) );
        set("coor/x",X_COOR);
